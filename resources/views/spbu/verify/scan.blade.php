...
<div class="animate-slide-in max-w-4xl mx-auto space-y-8">
    ...
    <div>
        ...
        <p class="text-sm text-slate-650 dark:text-slate-400">
            Scan barcode/QR code Surat Jalan yang dibawa driver untuk memverifikasi kedatangan dan menyelesaikan pengiriman.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
        {{-- INPUT SECTION --}}
        <div class="md:col-span-3 p-8 bg-white border border-slate-200/50 rounded-2xl dark:bg-slate-900/70 dark:border-slate-800 shadow-glass flex flex-col justify-between min-h-[380px]">
            <div class="space-y-6">
                <div class="flex items-center gap-3.5">
                    <div class="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-pertamina-blue to-blue-600 shadow-glow-blue text-white animate-pulse">
                ...
                <div class="space-y-4">
                    <div class="relative">
                        <input type="text" id="barcodeInput" autocomplete="off" placeholder="Pindai atau masukkan nomor Surat Jalan..." 
                        ...
                        <span class="absolute -translate-y-1/2 text-2xl text-slate-400 left-4 top-1/2 material-symbols-outlined">barcode_scanner</span>
                    </div>
            ...
            <div class="mt-8 p-4 bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-100 dark:border-slate-800">
                <div class="flex items-start gap-2.5">
                    ...
                    <p class="text-[11px] font-semibold text-slate-500 dark:text-slate-400 leading-relaxed">
                        <strong>Tips:</strong> Jika menggunakan hand-scanner, posisikan kursor input di kolom di atas, lalu scan barcode driver. Input akan otomatis terproses setelah barcode dibaca.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="md:col-span-2 space-y-6">
            <div id="scanFeedback" class="p-8 bg-slate-50 border border-dashed border-slate-350 rounded-2xl dark:bg-slate-900/30 dark:border-slate-800 flex flex-col items-center justify-center text-center min-h-[380px] transition-all duration-300">
                <div id="idleState" class="space-y-4">
                    <div class="flex items-center justify-center mx-auto size-20 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-1 max-w-[200px] mx-auto font-medium">Lakukan scan Surat Jalan driver untuk melihat informasi detail di sini</p>
                    </div>
                </div>

                <div id="loadingState" class="hidden space-y-4">
                    <div class="animate-spin rounded-full h-12 w-12 border-4 border-pertamina-blue border-t-transparent mx-auto"></div>
                    <p class="text-sm text-slate-500 font-bold">Memverifikasi kode...</p>
                </div>

                <div id="successState" class="hidden space-y-6 w-full">
                    <div class="flex items-center justify-center mx-auto size-16 rounded-full bg-pertamina-green/10 text-pertamina-green">
                    ...
                    <div class="p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 text-left text-xs space-y-2">
                        <div class="flex justify-between font-semibold"><span class="text-slate-400">No. Surat Jalan</span><span class="font-bold font-mono text-slate-900 dark:text-white" id="resCode">-</span></div>
                        <div class="flex justify-between font-semibold"><span class="text-slate-400">Nama Driver</span><span class="font-bold text-slate-900 dark:text-white" id="resDriver">-</span></div>
                        <div class="flex justify-between font-semibold"><span class="text-slate-400">Jenis BBM</span><span class="font-bold text-slate-900 dark:text-white" id="resFuel">-</span></div>
                        <div class="flex justify-between font-semibold"><span class="text-slate-400">Volume</span><span class="font-bold text-slate-900 dark:text-white" id="resVolume">-</span></div>
                        <div class="flex justify-between font-semibold"><span class="text-slate-400">No. Kendaraan</span><span class="font-bold text-slate-900 dark:text-white" id="resPlate">-</span></div>
                    </div>
                </div>

                <div id="errorState" class="hidden space-y-4">
                    <div class="flex items-center justify-center mx-auto size-16 rounded-full bg-pertamina-red/10 text-pertamina-red">
                    ...
                    <div>
                        ...
                        <p id="errorMessage" class="text-xs text-slate-500 mt-1 font-semibold max-w-[220px] mx-auto"></p>
                    </div>
                    <button type="button" onclick="resetScanner()" class="px-4 py-2 text-xs font-bold text-slate-700 bg-white border border-slate-200 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-350 rounded-lg hover:bg-slate-50">
                        Coba Lagi
                    </button>
                </div>
            </div>
