...
@section('content')
    <div class="animate-slide-in">
        ...
        <div
            ...
            {{-- hidden field untuk sma_n agar tetap konsisten --}}
            <input type="hidden" name="sma_n" value="{{ $smaN }}">
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            ...
            {{-- Kartu: Rekomendasi Terbaik (ditonjolkan) --}}
            <div
            ...
            {{-- Kartu: Tren 6 Bulan + Grafik mini --}}
            <div
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Ambil hanya garis "model terbaik" untuk prediksi
            const isSma = {{ $isSmaBetter ? 'true' : 'false' }};
            const bestPredData = isSma ? chartData.sma : chartData.slr;
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: ctx => ` ${Number(ctx.raw).toLocaleString('id-ID')} L`
                            }
                        }
                    },
                    scales: {
                        y: {
                            ...
                            ticks: {
                                ...
                                callback: v => (v / 1000).toFixed(1) + ' KL'
                            }
                        },
                        x: {
                            grid: { display: false },
            ...
            btn.addEventListener('click', function () {
                ...
                <div class="animate-pulse space-y-3 py-4">
                    ...
                    <div class="h-3 bg-slate-200 dark:bg-slate-700 rounded-full w-9/12"></div>
                </div>`;

                const aiUrl = '{{ route(auth()->user()->role === "admin_pusat" ? "superadmin.forecasting.ai-analysis" : "admin.forecasting.ai-analysis") }}';
                ...
                fetch(aiUrl, {
                    ...
                    .then(data => {
                        ...
                        <div class="mt-5 pt-3 border-t border-slate-200/50 dark:border-slate-800/50 flex justify-between items-center text-[10px] text-slate-400">
                            ...
                            throw new Error(data.message || 'Respons tidak valid dari AI.');
                        }
                    })
                    .catch(err => {
                        box.innerHTML = `
