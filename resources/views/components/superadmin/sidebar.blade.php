        ...
        <div class="flex items-center gap-4 mb-12 px-2">
            ...
            <div class="flex flex-col">
                ...
                <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider mt-0.5"
                    style="font-size: 10px;">Admin Pusat Portal</p>
            </div>
        </div>

        <!-- Nav -->
        <nav class="flex flex-col flex-1 gap-2 overflow-y-auto no-scrollbar">
            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/dashboard') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                ...
                @endif
                <span
                    class="material-symbols-outlined group-hover:scale-110 transition-transform text-[20px]">dashboard</span>
                <span class="text-sm">Dashboard Overview</span>
            </a>

            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/surat-jalan*') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                href="/superadmin/surat-jalan">
                @if(request()->is('superadmin/surat-jalan*'))
                    <div class="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-8 bg-pertamina-blue rounded-r-full"></div>
                @endif
                <span
            ...
            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/users-management') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                href="/superadmin/users-management">
                @if(request()->is('superadmin/users-management'))
                    <div class="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-8 bg-pertamina-blue rounded-r-full"></div>
                @endif
                <span
                    class="material-symbols-outlined group-hover:scale-110 transition-transform text-[20px]">group</span>
                <span class="text-sm">User Management</span>
            </a>

            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/master-data') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                href="{{ url('/superadmin/master-data') }}">
                @if(request()->is('superadmin/master-data'))
                    <div class="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-8 bg-pertamina-blue rounded-r-full"></div>
                @endif
                <span
                    class="material-symbols-outlined group-hover:scale-110 transition-transform text-[20px]">database</span>
                <span class="text-sm">Master Data</span>
            </a>

            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/live-monitoring') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                href="{{ route('superadmin.live-monitoring') }}">
                ...
                <span class="material-symbols-outlined group-hover:scale-110 transition-transform relative text-[20px]">
                    ...
                    <span class="absolute flex w-2 h-2 -top-1 -right-1">
                        <span
                            class="absolute inline-flex w-full h-full bg-pertamina-green rounded-full opacity-75 animate-ping"></span>
            ...
            <a class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all relative group {{ request()->is('superadmin/audit-reports') ? 'bg-pertamina-blue/10 text-pertamina-blue font-bold' : 'text-slate-500 hover:text-pertamina-blue hover:bg-white/50 dark:hover:bg-slate-800/50 font-medium' }}"
                href="/superadmin/audit-reports">
            ...
            <div class="glass-panel rounded-2xl p-4 flex flex-col gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col overflow-hidden">
                        ...
                        <p class="text-xs text-slate-500 font-medium">Admin Pusat</p>
                    </div>
                </div>
